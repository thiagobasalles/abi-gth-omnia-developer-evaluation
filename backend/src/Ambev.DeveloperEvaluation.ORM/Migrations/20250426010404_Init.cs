        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Number = table.Column<int>(type: "integer", maxLength: 7, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatePreApprove = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DateApproved = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DateCancelled = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeoLocalizations_Addresses_AddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeoLocalizations_AddressId",
                table: "GeoLocalizations",
                column: "AddressId",
                unique: true);
